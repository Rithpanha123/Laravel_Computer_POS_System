...
<div class="max-w-2xl mx-auto space-y-6 p-4 sm:p-6 rounded-3xl animated-gradient-bg relative overflow-hidden">
    ...
    <div class="flex items-center justify-between relative z-10">
        <div>
            <h2 class="text-xl font-bold text-gray-800 dark:text-white tracking-tight">បន្ថែមអ្នកផ្គត់ផ្គង់ថ្មី</h2>
            <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">កត់ត្រាព័ត៌មានក្រុមហ៊ុនផ្គត់ផ្គង់ទំនិញចូលស្តុក</p>
        </div>
    ...
    <form action="{{ route('suppliers.store') }}" method="POST" enctype="multipart/form-data" class="card-3d-hover glow-card bg-white dark:bg-slate-800 rounded-3xl border border-gray-100 dark:border-slate-700 shadow-sm p-6 sm:p-8 space-y-5 relative z-10">
        @csrf
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="supplier_name" value="{{ old('supplier_name') }}" placeholder="ឧ. Dell Official Cambodia" required class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-xs sm:text-sm text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 outline-none">
            </div>
            ...
            <div>
                ...
                <input type="text" name="contact_person" value="{{ old('contact_person') }}" placeholder="ឧ. លោក សុខា" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-xs sm:text-sm text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 outline-none">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="phone" value="{{ old('phone') }}" placeholder="012 345 678" required class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-xs sm:text-sm text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 outline-none">
            </div>
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" placeholder="supplier@mail.com" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-xs sm:text-sm text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 outline-none">
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="address" rows="3" placeholder="ទីតាំងក្រុមហ៊ុន..." class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-xs sm:text-sm text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 outline-none">{{ old('address') }}</textarea>
        </div>
